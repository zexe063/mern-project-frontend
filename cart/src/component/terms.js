...
function Terms(){
  ...
  <p className="mt-6 text-gray font-Inter w-[50%]">Welcome to version!</p>
  <p className="mt-6 text-gray font-Inter w-[50%]">
    These terms and conditions outline the rules and regulations for the use of
    version private limited's Website, located at
    https://mern-frontend-smoky.vercel.app/.
  </p>
  <p className="mt-6 text-gray font-Inter w-[50%]">
    By accessing this website we assume you accept these terms and conditions.
    Do not continue to use version if you do not agree to take all of the terms
  ...
  <p className="mt-6 text-gray font-Inter w-[50%]">
    We employ the use of cookies. By accessing version, you agreed to use
    cookies in agreement with the version private limited's Privacy Policy.{" "}
  </p>
  <p  className="mt-6 text-gray font-Inter w-[50%]">
  ...
  <p className="mt-6 text-gray font-Inter w-[50%]">
    Unless otherwise stated, version private limited and/or its licensors own
    the intellectual property rights for all material on version. All
    intellectual property rights are reserved. You may access this from version
    for your own personal use subjected to restrictions set in these terms and
    conditions.
  </p>
  <p>You must not:</p>
  <ul>
    <li>Republish material from version</li>
    <li>Sell, rent or sub-license material from version</li>
    <li>Reproduce, duplicate or copy material from version</li>
    <li>Redistribute content from version</li>
  </ul>
  <p className="mt-6 text-gray font-Inter w-[50%]">
  ...
  <p className="mt-6 text-gray font-Inter w-[50%]">
    ...
    opinions and information in certain areas of the website. version private
    ...
    version private limited,its agents and/or affiliates. Comments reflect the
    views and opinions of the person who post their views and opinions. To the
    extent permitted by applicable laws, version private limited shall not be
  ...
  <p className="mt-6 text-gray font-Inter w-[50%]">
    version private limited reserves the right to monitor all Comments and to
    remove any Comments which can be considered inappropriate, offensive or
    causes breach of these Terms and Conditions.
  </p>
  <p className="mt-6 text-gray font-Inter w-[50%]">You warrant and represent that:</p>
  <ul>
    <li>
  ...
  <p className="mt-6 text-gray font-Inter w-[50%]">
    You hereby grant version private limited a non-exclusive license to use,
  ...
  <p className="mt-6 text-gray font-Inter w-[50%]">
    ...
    compensates the absence of version private limited; and (d) the link is in
  ...
  <p className="mt-6 text-gray font-Inter w-[50%]">
    ...
    e-mail to version private limited. Please include your name, your
  ...
  <p className="mt-6 text-gray font-Inter w-[50%]">Approved organizations may hyperlink to our Website as follows:</p>
  <ul>
  ...
  <p className="mt-6 text-gray font-Inter w-[50%]">
    No use of version private limited's logo or other artwork will be allowed
